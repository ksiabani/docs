...
🔹 The **AIandMe Firewall** is released as **open-source software** to **promote responsible AI usage** and support AI security development.  

📌 More details & contributions → [**GitHub Repository**](https://github.com/aiandme-io/firewall)  
